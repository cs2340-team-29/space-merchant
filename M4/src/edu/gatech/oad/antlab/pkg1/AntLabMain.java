 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Harrison Katz");
		  toPrint += p1.toString("902704402");
          ...
          //and ggg000x with your gt num
          Person4 p4 = new Person4("Kevin Shu");
          toPrint += p4.toString("902693959");
		  //Person5 replace P5 with your name
          //and ggg000x with your gt num
          Person5 p5 = new Person5("Conner Bryan");
          toPrint += p5.toString("902818861");
