...
public class ChooseDifficultyAdapter extends ArrayAdapter<String>
{
    ...
    public ChooseDifficultyAdapter( Context context, int layoutResourceId, ArrayList<String> items )
    {
    ...
    public View getView( int position, View convertView, ViewGroup parent )
    {
        ...
        if ( convertView == null )
        {
            ...
            convertView = inf.inflate( R.layout.choose_difficulty_layout_view, parent, false );
